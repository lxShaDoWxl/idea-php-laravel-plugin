...
public class Symfony2InterfacesUtil {
    ...
    @Nullable
    protected Method getTraitMethod(Project project, String interfaceFQN, String methodName) {

        Collection<PhpClass> traits = PhpIndex.getInstance(project).getTraitsByFQN(interfaceFQN);
